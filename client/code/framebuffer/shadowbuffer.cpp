...
ShadowBuffer::ShadowBuffer() : ColorBuffer() {}

void ShadowBuffer::genBuffer(int width, int height, vector < FrameBufferData > data)
{
    this->width = width;
    this->height = height;
    ...
    if (glCheckFramebufferStatus(GL_FRAMEBUFFER) != GL_FRAMEBUFFER_COMPLETE)
    {
        ...
        throw runtime_error("ERROR::ShadowBuffer");
    }
...
void ShadowBuffer::genBuffer(vec2 size, vector < FrameBufferData > data)
{
